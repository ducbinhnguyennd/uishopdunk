...
const ProductCard = ({ sanpham }) => {
  ...
  return (
    <div className="product-card" onClick={() => navigate(`/chitietsanpham/${sanpham.namekhongdau}`)}>
      ...
      <div className="price">{sanpham.price} đ</div>
       <span className="old-price">{sanpham.price} đ</span>
      </div>
